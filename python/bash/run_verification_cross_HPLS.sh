...
python ../HPLS_verification_cross_load.py -p ../features/ -c ../datasets/pubfig/pubfig_full.txt -ftr PUBFIG-DEV-DEEP.bin -fts PUBFIG-EVAL-DEEP.bin -hm 100 -hs 100 -it 10
python ../HPLS_verification_cross_load.py -p ../features/ -c ../datasets/pubfig/pubfig_full.txt -ftr PUBFIG-DEV-DEEP.bin -fts PUBFIG-EVAL-DEEP.bin -hm 300 -hs 100 -it 10
python ../HPLS_verification_cross_load.py -p ../features/ -c ../datasets/pubfig/pubfig_full.txt -ftr PUBFIG-DEV-DEEP.bin -fts PUBFIG-EVAL-DEEP.bin -hm 500 -hs 100 -it 10

echo 'PUBFIG-DEV, PUBFIG-EVAL: DF, Hash_samples = 300, Iterations = 10'
python ../HPLS_verification_cross_load.py -p ../features/ -c ../datasets/pubfig/pubfig_full.txt -ftr PUBFIG-DEV-DEEP.bin -fts PUBFIG-EVAL-DEEP.bin -hm 100 -hs 300 -it 10
python ../HPLS_verification_cross_load.py -p ../features/ -c ../datasets/pubfig/pubfig_full.txt -ftr PUBFIG-DEV-DEEP.bin -fts PUBFIG-EVAL-DEEP.bin -hm 300 -hs 300 -it 10
python ../HPLS_verification_cross_load.py -p ../features/ -c ../datasets/pubfig/pubfig_full.txt -ftr PUBFIG-DEV-DEEP.bin -fts PUBFIG-EVAL-DEEP.bin -hm 500 -hs 300 -it 10

echo 'PUBFIG-DEV, PUBFIG-EVAL: DF, Hash_samples = 500, Iterations = 10'
python ../HPLS_verification_cross_load.py -p ../features/ -c ../datasets/pubfig/pubfig_full.txt -ftr PUBFIG-DEV-DEEP.bin -fts PUBFIG-EVAL-DEEP.bin -hm 100 -hs 500 -it 10
python ../HPLS_verification_cross_load.py -p ../features/ -c ../datasets/pubfig/pubfig_full.txt -ftr PUBFIG-DEV-DEEP.bin -fts PUBFIG-EVAL-DEEP.bin -hm 300 -hs 500 -it 10
python ../HPLS_verification_cross_load.py -p ../features/ -c ../datasets/pubfig/pubfig_full.txt -ftr PUBFIG-DEV-DEEP.bin -fts PUBFIG-EVAL-DEEP.bin -hm 500 -hs 500 -it 10
